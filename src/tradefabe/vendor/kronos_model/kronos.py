...
# VENDORING PATCH (tradefabe, #105) -- the ONLY edit to this file.
# Upstream reads:
#     import sys
#     sys.path.append("../")
#     from model.module import *
# That resolves `model.module` as a TOP-LEVEL package, which only works when cwd is the
# Kronos repo root. Vendored under src/tradefabe/vendor/, there is no top-level `model`
# package, so it raised ModuleNotFoundError. Rewritten as an explicit relative import.
# Same names, same star semantics -- no behavioural change to the model itself.
from .module import *
